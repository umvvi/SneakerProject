    ...
    <section class="py-12">
        ...
        <div class="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 px-10">
            ...
            <div class="bg-white rounded-lg shadow-lg overflow-hidden h-[500px]">
                <img src="{{ asset('img/stand-1.png') }}" alt="Event Amsterdam" class="w-full h-80 object-cover">
                <div class="p-6">
            ...
            <!-- Event 2 -->
            <div class="bg-white rounded-lg shadow-lg overflow-hidden h-[500px]">
                <img src="{{ asset('img/stand-2.jpg') }}" alt="Event Utrecht" class="w-full h-80 object-cover">
                <div class="p-6">
