        ...
        <section class="relative h-screen flex flex-col justify-center items-center text-center bg-gray-900 text-white">
            ...
            <div class="relative z-10 max-w-2xl px-4">
                ...
                <div class="flex justify-center space-y-4 md:space-y-0 md:space-x-4">
                    <a href="{{ url('/tickets/create') }}" class="bg-[#5DB7DE] text-white px-6 py-3 rounded-lg text-center">
                        Tickets Kopen
                    </a>
                    <a href="{{ url('/events') }}" class="bg-gray-700 text-white px-6 py-3 rounded-lg text-center">
                        Meer Info
                    </a>
                </div>
            </div>
                ...
                <div class="bg-white rounded-lg shadow-lg overflow-hidden h-[500px]">
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex space-x-4">
                            <a href="{{ url('/tickets/create') }}" class="bg-[#5DB7DE] text-white px-4 py-2 rounded-lg">
                                Koop tickets
                            </a>
                            <a href="{{ url('/stands') }}" class="text-[#5DB7DE] px-4 py-2 rounded-lg border border-[#5DB7DE]">
                                Meer info
                            </a>
                        </div>
                    </div>
